...
Double lat,lang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lang = Double.valueOf(intent.getStringExtra("long"));
    ...
    public void onMapReady(GoogleMap googleMap) {
      ...
      //  LatLng sydney = new LatLng(, );
        mMap.addMarker(new MarkerOptions().position(new LatLng(lat,lang)).title("Vidhayak Jee Location").icon(BitmapDescriptorFactory.fromResource(R.mipmap.ic_vidhayakicon)));
