 ...
 */
public class YourFragments extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_your_fragments, container, false);
...
//                new ColorDrawable(Color.parseColor("#1b1b1b")));
    ...
    public void populatedata(){
        ...
        final String url = Urls.completedstory;
