...
//                new ColorDrawable(Color.parseColor("#1b1b1b")));
    ...
    public void populatedata(){
      ...
      //  final String url = "http://vidhayak.ap-south-1.elasticbeanstalk.com/slimapp/public/api/posts/approved";
//        strtext =  SaveUserId.getInstance(getContext()).getUserId();
//        String newurl = url+strtext;


        JsonArrayRequest movieReq = new JsonArrayRequest(Urls.vidhayakJeeNews,
