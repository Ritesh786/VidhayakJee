 ...
 */
public class PendingStory extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_pending_story, container, false);
...
//                new ColorDrawable(Color.parseColor("#1b1b1b")));
    ...
    public void populatedata(){
        ...
        final String url = Urls.pendingstory;
