...
public class UploadStory extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if(v == mchooseimagebtn){
            ...
            AlertDialog.Builder mbuilder = new AlertDialog.Builder(UploadStory.this);
            ...
            mtakephoto.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    Intent cameraIntent = new Intent(UploadStory.this,CameraActivity.class);
    ...
    public void uploadImage() {
        ...
        String url = null;
        String REGISTER_URL = Urls.uploadstory;
        ...
        final ProgressDialog loading = ProgressDialog.show(UploadStory.this, "Uploading...", "Please wait...", false, false);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (success) {
                                ...
                                AlertDialog.Builder builder = new AlertDialog.Builder(UploadStory.this);
                        ...
                        loading.dismiss();
                        Toast.makeText(UploadStory.this, response.toString(), Toast.LENGTH_LONG).show();
                    }
                },
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toast.makeText(UploadStory.this, error.toString(), Toast.LENGTH_LONG).show();
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(UploadStory.this);
...
//        }
        ...
        if(requestCode==PICK_IMAGE_REQUEST) {
            ...
            if(data==null){
                ...
                Toast.makeText(UploadStory.this," Please Select Image For Uploading.... ",Toast.LENGTH_LONG).show();

            }else {
                Uri filePath = data.getData();
                Intent intentcrop = new Intent(UploadStory.this, CropImage.class);
