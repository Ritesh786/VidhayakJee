package fujitsu.vidhayak.vidhayakjee.FetchingPackage;
...
public class RecycleAdapter extends RecyclerView.Adapter<RecycleAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        imageLoader.get(movie.getThumbnailUrl(), ImageLoader.getImageListener(holder.thumbNail, R.mipmap.ic_vidhayakicon, android.R.drawable.ic_dialog_alert));
